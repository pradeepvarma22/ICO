                                    ...
                                    <li className="flex items-center py-2 space-x-4 xl:py-3">
                                        <div>
                                            {contractState.tokensToBeClaimed > 0 ?
                                                ...
                                                (
                                                    <div >
                                                        <input type="number" autofocus="true" ref={inputEl} className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" placeholder="No of Tokens" onChange={setTokenAmount} />
                                                        <div className="pt-5"></div>
