            ...
            <section className="container mx-auto px-6 p-10">
                ...
                <div className="flex items-center flex-wrap mb-20">
                    <div className="w-full md:w-1/2 pr-10">
                        <h4 className="text-3xl text-gray-800 font-bold mb-3">NFT's</h4>
                        <p className="text-gray-600 mb-8">
                            Non-fungible tokens (NFTs) are cryptographic assets on a blockchain with unique identification codes and metadata that distinguish them from each other.                        </p>
                    </div>
